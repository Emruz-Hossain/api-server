...
type CustomReplicationControllerInterface interface {
	Create(*v1alpha1.CustomReplicationController) (*v1alpha1.CustomReplicationController, error)
	Update(*v1alpha1.CustomReplicationController) (*v1alpha1.CustomReplicationController, error)
	UpdateStatus(*v1alpha1.CustomReplicationController) (*v1alpha1.CustomReplicationController, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.CustomReplicationController, error)
	List(opts v1.ListOptions) (*v1alpha1.CustomReplicationControllerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CustomReplicationController, err error)
...
func newCustomReplicationControllers(c *CustomrcV1alpha1Client, namespace string) *customReplicationControllers {
...
func (c *customReplicationControllers) Get(name string, options v1.GetOptions) (result *v1alpha1.CustomReplicationController, err error) {
	result = &v1alpha1.CustomReplicationController{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customReplicationControllers) List(opts v1.ListOptions) (result *v1alpha1.CustomReplicationControllerList, err error) {
	result = &v1alpha1.CustomReplicationControllerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customreplicationcontrollers").
...
func (c *customReplicationControllers) Create(customReplicationController *v1alpha1.CustomReplicationController) (result *v1alpha1.CustomReplicationController, err error) {
	result = &v1alpha1.CustomReplicationController{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customreplicationcontrollers").
...
func (c *customReplicationControllers) Update(customReplicationController *v1alpha1.CustomReplicationController) (result *v1alpha1.CustomReplicationController, err error) {
	result = &v1alpha1.CustomReplicationController{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customreplicationcontrollers").
...
func (c *customReplicationControllers) UpdateStatus(customReplicationController *v1alpha1.CustomReplicationController) (result *v1alpha1.CustomReplicationController, err error) {
	result = &v1alpha1.CustomReplicationController{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customreplicationcontrollers").
...
func (c *customReplicationControllers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CustomReplicationController, err error) {
	result = &v1alpha1.CustomReplicationController{}
