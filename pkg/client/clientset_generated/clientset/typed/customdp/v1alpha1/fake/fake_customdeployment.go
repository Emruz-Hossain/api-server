...
type FakeCustomDeployments struct {
	Fake *FakeCustomdpV1alpha1
	ns   string
}

var customdeploymentsResource = schema.GroupVersionResource{Group: "customdp.emruz.com", Version: "v1alpha1", Resource: "customdeployments"}

var customdeploymentsKind = schema.GroupVersionKind{Group: "customdp.emruz.com", Version: "v1alpha1", Kind: "CustomDeployment"}
