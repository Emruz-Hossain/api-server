...
package customdeployment_test

import (
	"time"

	. "api-server/pkg/apis/customdp/v1alpha1"
	. "api-server/pkg/client/clientset_generated/clientset/typed/customdp/v1alpha1"
...
var _ = Describe("CustomDeployment controller", func() {
	var instance CustomDeployment
	var expectedKey string
	var client CustomDeploymentInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = CustomDeployment{}
		instance.Name = "instance-1"
		expectedKey = "customdeployment-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.CustomdpV1alpha1().CustomDeployments("customdeployment-controller-test-handler")
