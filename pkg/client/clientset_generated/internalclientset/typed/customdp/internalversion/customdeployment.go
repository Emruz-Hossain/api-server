...
type CustomDeploymentInterface interface {
	Create(*customdp.CustomDeployment) (*customdp.CustomDeployment, error)
	Update(*customdp.CustomDeployment) (*customdp.CustomDeployment, error)
	UpdateStatus(*customdp.CustomDeployment) (*customdp.CustomDeployment, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*customdp.CustomDeployment, error)
	List(opts v1.ListOptions) (*customdp.CustomDeploymentList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *customdp.CustomDeployment, err error)
...
func newCustomDeployments(c *CustomdpClient, namespace string) *customDeployments {
...
func (c *customDeployments) Get(name string, options v1.GetOptions) (result *customdp.CustomDeployment, err error) {
	result = &customdp.CustomDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customDeployments) List(opts v1.ListOptions) (result *customdp.CustomDeploymentList, err error) {
	result = &customdp.CustomDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customdeployments").
...
func (c *customDeployments) Create(customDeployment *customdp.CustomDeployment) (result *customdp.CustomDeployment, err error) {
	result = &customdp.CustomDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customdeployments").
...
func (c *customDeployments) Update(customDeployment *customdp.CustomDeployment) (result *customdp.CustomDeployment, err error) {
	result = &customdp.CustomDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customdeployments").
...
func (c *customDeployments) UpdateStatus(customDeployment *customdp.CustomDeployment) (result *customdp.CustomDeployment, err error) {
	result = &customdp.CustomDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customdeployments").
...
func (c *customDeployments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *customdp.CustomDeployment, err error) {
	result = &customdp.CustomDeployment{}
