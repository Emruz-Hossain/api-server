...
type CustomReplicationControllerLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.CustomReplicationController, err error)
...
// List lists all CustomReplicationControllers in the indexer.
func (s *customReplicationControllerLister) List(selector labels.Selector) (ret []*v1alpha1.CustomReplicationController, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.CustomReplicationController))
	})
	return ret, err
}
...
type CustomReplicationControllerNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.CustomReplicationController, error)
...
// List lists all CustomReplicationControllers in the indexer for a given namespace.
func (s customReplicationControllerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.CustomReplicationController, err error) {
...
// Get retrieves the CustomReplicationController from the indexer for a given namespace and name.
func (s customReplicationControllerNamespaceLister) Get(name string) (*v1alpha1.CustomReplicationController, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("customreplicationcontroller"), name)
	}
	return obj.(*v1alpha1.CustomReplicationController), nil
}
