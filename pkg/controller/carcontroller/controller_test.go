...
package carcontroller_test

import (
	"time"

	. "api-server/pkg/apis/car/v1alpha1"
	. "api-server/pkg/client/clientset_generated/clientset/typed/car/v1alpha1"
...
var _ = Describe("CarController controller", func() {
	var instance CarController
	var expectedKey string
	var client CarControllerInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = CarController{}
		instance.Name = "instance-1"
		expectedKey = "carcontroller-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.CarV1alpha1().CarControllers("carcontroller-controller-test-handler")
